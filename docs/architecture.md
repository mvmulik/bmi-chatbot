...
5. **Data (`data/`)** — Raw crawls, processed chunks, ChromaDB persistence, and gitignored auth storage.
6. **AI** — Azure OpenAI or OpenAI-compatible providers configured via `.env`.
